...
<body>
	...
	<div class="main-title">
		...
		<ul class="tab-nav nav">
			<li <?php if(($id) == $kes[0]): ?>class="current"<?php endif; ?> /><a href="<?php echo U('?id='.$kes[0]);?>"><?php echo ($type[1]); ?>配置</a></li>
			<li <?php if(($id) == $kes[1]): ?>class="current"<?php endif; ?>/><a href="<?php echo U('?id='.$kes[1]);?>"><?php echo ($type[2]); ?>配置</a></li>
			<?php if($uid == 1 ): ?><li <?php if(($id) == $kes[2]): ?>class="current"<?php endif; ?>/><a href="<?php echo U('?id='.$kes[2]);?>"><?php echo ($type[3]); ?>配置</a></li>
			<li <?php if(($id) == $kes[3]): ?>class="current"<?php endif; ?>/><a href="<?php echo U('?id='.$kes[3]);?>"><?php echo ($type[4]); ?>配置</a></li><?php endif; ?>
		</ul>
