...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <?php if($info['pid'] == 0 ): ?><div class="form-item">
            <label class="item-label">控制器名<span class="check-tips">（用于后台显示的配置标题）</span></label>
            <div class="controls">
        ...
        <?php if($info['pid'] > 0 ): ?><div class="form-item">
            <label class="item-label">方法名<span class="check-tips">（格式:视图文件夹/视图文件）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="view" value="<?php echo ((isset($info["view"]) && ($info["view"] !== ""))?($info["view"]):''); ?>">
            </div>
        </div><?php endif; ?>
        <div class="form-item">
