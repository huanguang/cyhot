            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <div class="logo1"><img src="Public/Admin/images/logo.png"></div>
                        <div id="itemBox" class="item-box">
                            <div class="login_box">
                                <div class="item" style=" border-radius:3px 3px 0 0">
                                ...
                                <div class="item verifycode" style="position:relative;border-radius:0 0 3px 3px">
                                    <i class="icon-login-verifycode"></i>
                                    <input type="text" name="verify" placeholder="请填写验证码" autocomplete="off">
                                <div style="width:150px;height:40px;position:absolute;right:0;top:0;">
                                    <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo U('Public/verify');?>" width="88" height="40">
                                </div>
